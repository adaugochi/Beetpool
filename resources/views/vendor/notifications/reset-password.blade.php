        ...
        <tr>
            <td style="padding: 0 30px 20px">
                ...
                <div style="text-align: center;">
                    <a href="{{ $actionUrl }}" style="background-color:#6576ff;border-radius:4px;color:#ffffff;display:inline-block;line-height:44px;text-transform:uppercase;padding: 0 30px">Reset Password</a>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="padding: 20px 30px 40px">
                ...
                <p style="margin: 0; font-size: 13px; line-height: 22px; color:#9ea8bb;">
                    ...
                    If you face any issues, please contact us at  support@beetpool.com
                </p>
            </td>
        </tr>
        </tbody>
